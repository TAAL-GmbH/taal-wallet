...
import { WocApiError } from '@/utils/errors/woc-api-error';
import { isString } from '@/utils/generic';
import { setBatchBalance } from './pk-slice';
import { wocApiSlice } from './woc-api-slice';
...
export const getTransactionData = async (
  ...args: Parameters<typeof wocApiSlice.endpoints.getTransactionData.initiate>
) => store.dispatch(wocApiSlice.endpoints.getTransactionData.initiate(...args));
...
export const getSpentTx = async (...args: Parameters<typeof wocApiSlice.endpoints.getSpentTx.initiate>) =>
  store.dispatch(wocApiSlice.endpoints.getSpentTx.initiate(...args));

...
import { DialogData, SignPreimageData } from '@/types';
import { Tabs } from '@/components/tabs';
import { RawDataPreview } from './data-preview/raw-data-preview';
import { PreimageMediaParser } from './data-preview/preimage-media-parser';
import { ConfirmOrigin } from './confirm-origin';
import { HtmlContent } from './html-content';
import { Heading } from '@/components/generic/heading';
import { parseRecipientListFromTx, parseScript, parseStasTx, parseTokenTx } from '@/utils/blockchain';
import { RecipientList } from './data-preview/recipient-list';
import { TokenDetails } from './data-preview/token-details';
import { FromToAddress } from './from-to-address';
